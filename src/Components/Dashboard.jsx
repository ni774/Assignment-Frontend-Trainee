  ...
  return (
    <div className="min-h-screen bg-sky-200 p-[10px]">
        <div className="flex justify-between font-serif">
            <span className="text-xl">CNAPP Dashboard</span>
            <div className="">
                <span onClick={()=>setOpenAddWidget(!openAddWidget)} className="p-1 ml-4 mr-4">
                  <AddWidgetButton />
                </span>
                <span onClick={()=>window.location.reload()} className="mr-4 p-1 rounded-md bg-white"><CachedOutlinedIcon /></span>
                <span className="mr-2 rounded-md bg-white p-1"><MoreVertOutlinedIcon /></span>
        ...
        <div className="mt-5">
          <Widgets searchKeywords={searchKeywords} wholeData={wholeData} setOpenAddWidget={setOpenAddWidget}/>
        </div>
    </div>
  );
}
